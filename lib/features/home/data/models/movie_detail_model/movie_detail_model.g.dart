...
_SpokenLanguages _$SpokenLanguagesFromJson(Map<String, dynamic> json) =>
    _SpokenLanguages(
...
Map<String, dynamic> _$SpokenLanguagesToJson(_SpokenLanguages instance) =>
    <String, dynamic>{
...
_ProductionCountries _$ProductionCountriesFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ProductionCountriesToJson(
  _ProductionCountries instance,
) => <String, dynamic>{'iso_3166_1': instance.iso31661, 'name': instance.name};

_ProductionCompanies _$ProductionCompaniesFromJson(Map<String, dynamic> json) =>
